...
class PokerPatienceGrid
{
     ...
     *
     * @var array<mixed> $cardGrid An array of Card instances.
     */
    private $cardGrid;
     ...
     *
     * @return array<mixed> The current grid state.
     */
     ...
     *
     * @param array<int> $newGrid An array of integers representing the new grid state
    ...
    /**
     * Establishes initial empty scores for the game.
     *
     * @return array<mixed> An associative array containing initial scores for horizontal- and
     * vertical scores, and current_score.
     */
